...
<script>
    ...
    function showUpdate(obj) {
        ...
        editor.customConfig.uploadImgServer = '/manage/book/upload' //设置图片上传路径
    ...
    function showCreate() {
        ...
        editor.customConfig.uploadImgServer = '/manage/book/upload';//设置图片上传地址
    ...
    layui.form.on('submit(btnSubmit)', function (data) {
        ...
        //向服务器发送请求
        $.post("/manage/book/" + optype, formData, function (json) {
            if (json.code == "0") {
    ...
    function showDelete(obj) {
        ...
        layui.layer.confirm('确定要执行删除操作吗?', {icon: 3, title: '提示'}, function (index) {
            ...
            $.get("/manage/book/delete/" + bookId, {}, function (json) {
                if (json.code == "0") {
                    //删除成功刷新表格
                    table.reload('bookList');
                    //提示操作成功
