...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <!--注销按钮-->
            <li class="layui-nav-item"><a href="/manage/logout">注销</a></li>
        </ul>
    </div>
    <!--左侧菜单栏-->
            ...
            <ul class="layui-nav layui-nav-tree">
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="xxx">
                            <dd><a href="/manage/book/index.html" target="ifmMain">图书管理</a></dd>
                            <dd><a href="/manage/evaluation/index.html" target="ifmMain">短评管理
                                </a></dd>
                        </dl>
                    </li>
    ...
    <div class="layui-body" style="overflow-y: hidden">
        <iframe name="ifmMain" style="border: 0;width: 100%;height: 100%" src="/manage/book/index.html"></iframe>
    </div>
    <!--版权信息-->
